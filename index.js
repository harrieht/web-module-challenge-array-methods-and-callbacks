...
function getWinners(data, getFianalsCB) {
    return getFianalsCB(data).map(item => item['Home Team Goals'] > item['Away Team Goals'] ?
...
const countryWins = data.reduce(function(acc, item){
  ...
  return countryWins;
    ...
    console.log('Strech 1', getCountryWins(fifaData));
